...
import ImageHoster.util.ImageHosterUtil;
...
public class UserController {
    ...
    public String registerUser(User user, Model model) {
        final String error = "Password must contain at least 1 alphabet, 1 number & 1 special character";
        ImageHosterUtil imageHosterUtil = new ImageHosterUtil();
        if(imageHosterUtil.validate(user.getPassword())) {
