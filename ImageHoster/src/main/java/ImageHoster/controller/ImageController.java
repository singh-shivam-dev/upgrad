...
public class ImageController {
    ...
    public String saveComment(@PathVariable("imageId") int imageId, @PathVariable("imageTitle") String title, Model model, Comment comment ) {
    ...
    public String editImage(@RequestParam("imageId") Integer imageId, @RequestParam("loggedInUsersId") Integer loggedInUsersId, Model model) {
        System.out.println(loggedInUsersId);
        //Image image = imageService.getImage(imageId);
        Image image = imageService.getImageById(imageId);
        if(image.getUser().getId().equals(loggedInUsersId)) {
    ...
    public String deleteImageSubmit(@RequestParam(name = "imageId") Integer imageId, @RequestParam("loggedInUsersId") Integer loggedInUsersId, Model model) {
        Image image = imageService.getImageById(imageId);
        if(image.getUser().getId().equals(loggedInUsersId)) {
